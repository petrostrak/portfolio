    ...
    <section id="about">
        <div className="about container">
            ...
            <div className="col-right">
                ...
                <a href="https://drive.google.com/file/d/1bH7NnfS9IZTbb4lp3yyeWR1BmsOEQJbY/view?usp=sharing" download="https://drive.google.com/file/d/1bH7NnfS9IZTbb4lp3yyeWR1BmsOEQJbY/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="cta">Download Resume</a>
            </div>
        </div>
    </section>
);

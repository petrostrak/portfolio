            ...
            <div className="all-projects">
                <div className="project-item">
                    <div className="project-info">
                        <h1><a href="https://react-project-no0.herokuapp.com" target="_blank" rel="noopener noreferrer">An introduction to React-js framework</a></h1>
                ...
                <div className="project-item">
                    <div className="project-info">
                        <h1><a href="https://react-project-no1.herokuapp.com/" target="_blank" rel="noopener noreferrer">React project</a></h1>
                ...
                <div className="project-item">
                    <div className="project-info">
                        <h1><a href="https://github.com/petrostrak/Spring-Boot-Token-based-Authentication-with-Spring-Security-JWT" target="_blank" rel="noopener noreferrer">Spring Boot application</a></h1>
                ...
                <div className="project-item">
                    <div className="project-info">
                        <h1><a href="https://github.com/petrostrak/airSense" target="_blank" rel="noopener noreferrer">AirSense</a></h1>
